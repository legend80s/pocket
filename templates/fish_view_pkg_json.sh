...
# desc.en: Quickly peek into package.json — uses current project's by default, or looks in node_modules/ if name specify. You can also pass a key to see just that value
